...
namespace Oranikle.DesignBase.UI.Docking
{
    ...
    [ToolboxBitmap(typeof(resfinder), "Oranikle.DesignBase.UI.Docking.DockPanel.bmp")]
	...
	public partial class DockPanel : Panel
	{
        ...
        private EventHandler m_dummyControlResizeEventHandler = null;
        private void InvalidateWindowRegion()
        {
            ...
            if(m_dummyControlResizeEventHandler == null)
                m_dummyControlResizeEventHandler = new EventHandler(DummyControl_SizeChanged);


            //DummyControl.Paint += m_dummyControlPaintEventHandler;
            DummyControl.SizeChanged += m_dummyControlResizeEventHandler;
            //DummyControl.Invalidate();
        }

        void DummyControl_SizeChanged(object sender, EventArgs e)
        {
            DummyControl.SizeChanged -= m_dummyControlResizeEventHandler;
            UpdateWindowRegion();
        }
