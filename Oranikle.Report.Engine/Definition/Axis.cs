...
namespace Oranikle.Report.Engine
{
	...
	public class Axis : ReportLink
	{
		...
		public Expression MajorInterval
		{
			get { return  _MajorInterval; }
			set {  _MajorInterval = value; }
		}

		public Expression MinorInterval
		{
		...
		public double MaxEval(Report r, Row row)
		{
			if (_Max == null)
		...
		public double MinEval(Report r, Row row)
		{
			if (_Min == null)
                return (double)int.MinValue;
