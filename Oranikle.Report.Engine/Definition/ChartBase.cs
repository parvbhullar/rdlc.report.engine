...
namespace Oranikle.Report.Engine
{
	...
	public abstract class ChartBase : IDisposable
	{
		...
		public virtual void Draw(Report rpt)
		{
		}
	...
	//		_bm.Save(stream, im);
		...
		public System.Drawing.Imaging.Metafile Image(Report rpt) // GJL 14082008 Using Vector Graphics
		{
			if (_bm == null)
				Draw(rpt);
		...
		public void DrawLegendMarker(Graphics g, Brush b, Pen p, ChartMarkerEnum marker, int x, int y, int mSize)
		{
			PointF[] points;
			switch (marker)
			{
