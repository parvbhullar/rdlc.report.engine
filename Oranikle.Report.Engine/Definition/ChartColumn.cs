...
namespace Oranikle.Report.Engine
{
	...
	///</summary>
	public class ChartColumn: ChartBase
	{
		int _GapSize=0;		// TODO: hard code for now - 06122007AJM Removed gap so that large category ranges display better

        public ChartColumn(Report r, Row row, Chart c, MatrixCellEntry[,] m, Expression showTooltips, Expression showTooltipsX,Expression _ToolTipYFormat, Expression _ToolTipXFormat)
        ...
        public void DrawLegendLineMarker(Graphics g, Brush b, Pen p, ChartMarkerEnum marker, int x, int y, int mSize)
        {
