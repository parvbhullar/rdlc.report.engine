...
namespace Oranikle.Report.Engine
{
	...
	///</summary>
	[Serializable]
	public class ChartLine: ChartColumn
	{

        public ChartLine(Report r, Row row, Chart c, MatrixCellEntry[,] m, Expression showTooltips, Expression showTooltipsX,Expression _ToolTipYFormat, Expression _ToolTipXFormat)
