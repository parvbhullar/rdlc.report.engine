...
namespace Oranikle.Report.Engine
{
    public class MapData
    {
        ...
        /// <returns></returns>
        static public MapData Create(string file)
        {
        ...
        public void AddPolygon(PointF[] polygon, string[] entries)
        {
        ...
        public List<MapPolygon> GetPolygon(string key)
        {
    ...
    public abstract class MapObject
    {
        ...
        public abstract void Draw(Graphics g, float scale, float offX, float offY);
    }

    public class MapLines : MapObject
    {
        PointF[] _Lines = null;
        float _MaxX=0;
        float _MaxY=0;

        public MapLines(PointF[] lines) : base()
        {
            _Lines = lines;
        ...
        public override void Draw(Graphics g, float scale, float offX, float offY)
        {
    ...
    public class MapPolygon : MapObject
    {
        ...
        public MapPolygon(PointF[] poly) : base()
        {
            PointF[] fpoly;
    ...
    public class MapText : MapObject
    {
        ...
        public MapText(string val, PointF xy) : base()
        {
            _Text = val;
            _Location = xy;
        }
