...
namespace Oranikle.Report.Engine
{
	...
	///</summary>
	public class ChartPie: ChartBase
	{

        public ChartPie(Report r, Row row, Chart c, MatrixCellEntry[,] m, Expression showTooltips, Expression showTooltipsX,Expression _ToolTipYFormat, Expression _ToolTipXFormat)
