...
namespace Oranikle.Report.Engine
{
	...
	///</summary>
	[Serializable]
	public class DataSourceDefn : ReportLink
	{
		...
		public bool IsConnected(Report rpt)
		{
		...
		public bool ConnectDataSource(Report rpt)
		{
		...
		public bool IsUserConnection(Report rpt)
		{
			if (rpt == null)
				return false;
		...
		public void SetUserConnection(Report rpt, IDbConnection cn)
		{
            if (cn == null)
		...
		public IDbConnection GetConnection(Report rpt)
		{
			IDbConnection cn;
		...
		public void CleanUp(Report rpt)
		{
		...
		public IDbConnection SqlConnect(Report rpt)
		{
