...
namespace Oranikle.Report.Engine
{
	...
	public sealed class DataSourceReference
	{
        ...
        /// <summary>
        /// Retrieve the string data from an file.   Retrieve assumes 
        /// that Create was used to create the file.
        /// </summary>
        /// <param name="filename">File name to retrieve data from.</param>
        /// 
        /// <returns>Unencrypted string contents of file</returns>
        static public string Retrieve(string filename)
        {
            
            string outdata = null;
            try
            {
                //outdata = Encoding.UTF8.GetString(enc);
