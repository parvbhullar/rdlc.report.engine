...
namespace Oranikle.Report.Engine
{
    public class EMF
    {
        ...
        public EMF(Single Xin, Single Yin, Single Widthin, Single Heightin)
        {
            X = Xin;
            Y = Yin;
            Width = Widthin;
        ...
        public bool MetafileCallback(EmfPlusRecordType recordType, int flags, int dataSize, IntPtr data, PlayRecordCallback callbackData)
        {
