...
namespace Oranikle.Report.Engine
{
	...
	///</summary>
	[Serializable]
	public class Filter : ReportLink
	{
		...
		public void Apply(Report rpt, Rows data)
		{
		...
		static public int ApplyCompare(TypeCode tc, object left, object right)
		{
			if (left == null)
			{
		...
		static public int ApplyCompare(object left, object right) 
		{
			if (left is string)
				return ((string) left).CompareTo(Convert.ToString(right));
			if (left is decimal)
		...
		public bool FilterOperatorSingleRow
		{
