...
namespace Oranikle.Report.Engine
{
	...
	///</summary>
	[Serializable]
	public class Matrix : DataRegion
	{
		...
		public void RunReset(Report rpt)
		{
			RemoveValue(rpt);
		}
        ...
        public float[] ColumnWidths(MatrixCellEntry[,] matrix, int maxColumns)
        {
		...
		public ColumnGroupings ColumnGroupings
		{
			get { return  _ColumnGroupings; }
			set {  _ColumnGroupings = value; }
		}

		public Rows GetMyData(Report rpt)
		{
			WorkClass wc = GetValue(rpt);
			return wc.Data;
		}

		public void SetMyData(Report rpt, Rows data)
		{
			WorkClass wc = GetValue(rpt);
			wc.Data = data;
		}

		public RowGroupings RowGroupings
		{
			get { return  _RowGroupings; }
			set {  _RowGroupings = value; }
		}

		public MatrixRows MatrixRows
		{
		...
		public MatrixLayoutDirectionEnum LayoutDirection
		{
		...
		public MatrixCellDataElementOutputEnum CellDataElementOutput
		{
