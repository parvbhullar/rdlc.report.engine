...
namespace Oranikle.Report.Engine
{
	...
	public class MatrixEntry
	{
		...
		public MatrixEntry(Row r, string hash, MatrixEntry p, int rowCount)
		{
            _r = r;
            _hash = hash;
		...
		public Dictionary<string, MatrixEntry> HashData
		{
		...
		public List<MatrixEntry> GetSortedData(Report rpt)
		{
		...
		public MatrixEntry Parent
		{
			get { return  _Parent; }
		}

		public ColumnGrouping ColumnGroup
		{
