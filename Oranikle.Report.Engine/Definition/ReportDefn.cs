...
namespace Oranikle.Report.Engine
{
	...
	{
		public int _ObjectCount=0;	// master object counter
		...
		public void SetObjectNumber(int oc)
		{
			_ObjectCount = oc;
		}

		// Obtain the data for the report
		public bool RunGetData(Report rpt, IDictionary parms)
		{
            bool bRows = false;
		...
		public string CreateDynamicName(object ro)
		{
		...
		public IDictionary LUDynamicNames
		{
        ...
        public List<ICacheData> DataCache
		{
			get { return _DataCache; }
		}

		public DataSourcesDefn DataSourcesDefn
		{
			get { return  _DataSourcesDefn; }
		}

		public DataSetsDefn DataSetsDefn
		{
		...
		public float BottomOfPage		// this is the y coordinate just above the page footer
		{
			get 
			{
				if (this.Subreport != null)
		...
		public CodeModules CodeModules
		{
		...
		public IDictionary LUGlobals
		{
			get { return  _LUGlobals; }
		}

		public IDictionary LUUser
		{
			get { return  _LUUser; }
		}
		
		public IDictionary LUReportItems
		{
			get { return  _LUReportItems; }
		}
		
		public IDictionary LUAggrScope
		{
			get { return  _LUAggrScope; }
		}

		public IDictionary LUReportParameters
		{
			get 
			{
		...
		public IDictionary LUEmbeddedImages
		{
