...
namespace Oranikle.Report.Engine
{
	...
	///</summary>
	[Serializable]
	public class ReportItem : ReportLink, IComparable
	{
		...
		public ReportItem(ReportDefn r, ReportLink p, XmlNode xNode) : base(r, p)
		{
			_Name=null;
			_Style=null;
			_Action=null;
		...
		public void PositioningFinalPass(int i, List<ReportItem> items)
		{
		...
		public bool IsTableOrMatrixCell(Report rpt)
		{
		...
		public float LeftCalc(Report rpt)
		{
			WorkClass wc = GetWC(rpt);
		...
		public float HeightOrOwnerHeight
		{
			get
			{
				if (_Height != null)
		...
		public void SetPageLeft(Report rpt)
		{
			if (this._TC != null)		
			{	// must be part of a table
				Table t = _TC.OwnerTable;
		...
		public MatrixCellEntry GetMC(Report rpt)
		{
			WorkClass wc = GetWC(rpt);
			return wc.MC;
		}

		public void SetMC(Report rpt, MatrixCellEntry mce)
		{
			WorkClass wc = GetWC(rpt);
			wc.MC = mce;
		}
		...
		public float WidthOrOwnerWidth(Report rpt)
		{
			if (_Width != null)
		...
		public void SetPagePositionBegin(Pages pgs)
		{
		...
		public void SetPagePositionEnd(Pages pgs, float pos)
		{
		...
		/// above it vertically.
		/// </summary>
		public float RelativeY(Report rpt)
		{
			float top = _Top == null? 0: _Top.Points;
			ReportItem saveri=GetReportItemAbove(rpt);
			if (saveri == null)
		...
		public Expression ToolTip
		{
			get { return  _ToolTip; }
			set {  _ToolTip = value; }
		}

		public string ToolTipValue(Report rpt, Row r)
		{
			if (_ToolTip == null)
				return null;
		...
		public Expression Bookmark
		{
			get { return  _Bookmark; }
			set {  _Bookmark = value; }
		}

		public string BookmarkValue(Report rpt, Row r)
		{
			if (_Bookmark == null)
				return null;
        ...
        public List<ReportItem> YParents
		{
			get { return this._YParents; }
		}

		virtual public DataElementOutputEnum DataElementOutput
		{
			get 
			{
		...
		public virtual void RemoveWC(Report rpt)
		{
		...
		class WorkClass
		{
			public MatrixCellEntry MC;	// matrix cell entry
			public float BottomPosition;	// used when calculating position of objects below this one.
