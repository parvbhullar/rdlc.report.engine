...
namespace Oranikle.Report.Engine
{
	...
	///</summary>
	[Serializable]
    public class ReportItems : ReportLink, IEnumerable
	{
		...
		public void RunPage(Pages pgs, Row row, float xOffset)
		{
		...
		public void SetXOffset(Report rpt, float f)
		{
			OFloat of = rpt.Cache.Get(this, "xoffset") as OFloat;
			if (of == null)
