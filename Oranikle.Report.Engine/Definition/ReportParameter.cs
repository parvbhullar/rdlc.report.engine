...
namespace Oranikle.Report.Engine
{
	...
	///</summary>
	[Serializable]
	public class ReportParameter : ReportLink
	{
		...
		public object GetRuntimeValue(Report rpt)
		{
        ...
        public ArrayList GetRuntimeValues(Report rpt)
        {
		...
		public void SetRuntimeValue(Report rpt, object v)
		{
            if (this.MultiValue)
        ...
        public void SetRuntimeValues(Report rpt, ArrayList vs)
        {
            if (!this.MultiValue)
		...
		public TrueFalseAutoEnum UsedInQuery
		{
	...
	public class UserReportParameter
	{
		...
		public object Value
		{
			...
			set 
			{
                ...
                if (this.MultiValue && value is Guid)
                {
                    Values = ParseValue(value.ToString());
                    return;
                }
