...
namespace Oranikle.Report.Engine
{
	...
	///</summary>
    public class Rows : System.Collections.Generic.IComparer<Row>  
	{
		...
		public Rows(Report rpt, Rows r, int start, int end, BitArray ba)
		{
			_Rpt = rpt;
			_SortBy = null;
			_CurrentGroups = null;
        ...
        static public Rows CreateOneRow(Report rpt)
        {
		...
		public Rows(Report rpt, TableGroups tg, Grouping g, Sorting s)
		{
			_Rpt = rpt;
        ...
        public List<RowsSortExpression> SortBy
		{
			get { return  _SortBy; }
			set { _SortBy = value; }
		}

		public GroupEntry[] CurrentGroups
		{
	...
	public class RowsSortExpression
	{
		...
		public RowsSortExpression(Expression e, bool asc)
		{
			expr = e;
			bAscending = asc;
		}

		public RowsSortExpression(Expression e)
		{
			expr = e;
			bAscending = true;
		}
