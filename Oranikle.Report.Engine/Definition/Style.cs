...
namespace Oranikle.Report.Engine
{
	...
	public class Style : ReportLink
	{
		...
		public void DrawBackground(Report rpt, Graphics g, Row r, System.Drawing.Rectangle rect)
		{
		...
		public void DrawBackgroundCircle(Report rpt, Graphics g, Row r, System.Drawing.Rectangle rect)
		{
		...
		public void DrawBorder(Report rpt, Graphics g, Row r, System.Drawing.Rectangle rect)
		{
		...
		public void DrawStyleLine(Report rpt, Graphics g, Row r, Point s, Point e)
		{
			Pen p = null;
			Brush b = null;
			try
		...
		//  information
		public void DrawString(Report rpt, Graphics g, object o, TypeCode tc, Row r, System.Drawing.Rectangle rect)
		{
		...
		static public void DrawStringDefaults(Graphics g, object o, System.Drawing.Rectangle rect)
		{
			Font drawFont=null;
		...
		//  information
		public Size MeasureString(Report rpt, Graphics g, object o, TypeCode tc, Row r, int maxWidth)
		{
			Font drawFont=null;				// Font we'll draw with
			StringFormat drawFormat=null;	// StringFormat we'll draw with
			string s;						// the string to draw
		...
		static public Size MeasureStringDefaults(Report rpt, Graphics g, object o, TypeCode tc, Row r, int maxWidth)
		{
			Font drawFont=null;				// Font we'll draw with
			StringFormat drawFormat=null;	// StringFormat we'll draw with
			string s;						// the string to draw
		...
		public Brush GetBrush(Report rpt, Row r)
		{
			Brush drawBrush;
		...
		public Font GetFont(Report rpt, Row r)
		{
        ...
        public StringFormat GetStringFormat(Report rpt, Row r)
        {
            return GetStringFormat(rpt, r, StringAlignment.Center);
        }

		public StringFormat GetStringFormat(Report rpt, Row r, StringAlignment defTextAlign)
		{
			// Set format of string.
		...
		static public string GetFormatedString(Report rpt, Style s, Row row, object o, TypeCode tc)
		{
			string t = null;
			if (o == null)
				return "";
		...
		public System.Drawing.Rectangle PaddingAdjust(Report rpt, Row r, System.Drawing.Rectangle rect, bool bAddIn)
		{
		...
		public StyleBorderColor BorderColor
		{
			get { return  _BorderColor; }
			set {  _BorderColor = value; }
		}

		public StyleBorderStyle BorderStyle
		{
			get { return  _BorderStyle; }
			set {  _BorderStyle = value; }
		}

		public StyleBorderWidth BorderWidth
		{
		...
		public Color EvalBackgroundColor(Report rpt, Row row)
		{
			if (_BackgroundColor == null)
		...
		public BackgroundGradientTypeEnum EvalBackgroundGradientType(Report rpt, Row r)
		{
			if (_BackgroundGradientType == null)
		...
		public Color EvalBackgroundGradientEndColor(Report rpt, Row r)
		{
			if (_BackgroundGradientEndColor == null)
				return System.Drawing.Color.Empty;
		...
		public StyleBackgroundImage BackgroundImage
		{
			get { return  _BackgroundImage; }
			set {  _BackgroundImage = value; }
		}

		public bool ConstantStyle
		{
		...
		public bool IsFontItalic(Report rpt, Row r)
		{
		...
		public FontStyleEnum EvalFontStyle(Report rpt, Row row)
		{
			if (_FontStyle == null)
		...
		public string EvalFontFamily(Report rpt, Row row)
		{
			if (_FontFamily == null)
				return "Arial";
		...
		public float EvalFontSize(Report rpt, Row row)
		{
			if (_FontSize == null)
				return 10;
		...
		public FontWeightEnum EvalFontWeight(Report rpt, Row row)
		{
			if (_FontWeight == null)
		...
		public bool IsFontBold(Report rpt, Row r)
		{
			if (this.FontWeight == null)
				return false;
        ...
        public string EvalFormat(Report rpt, Row row)
        {
            if (_Format == null)
                return "General";
		...
		public TextDecorationEnum EvalTextDecoration(Report rpt, Row r)
		{
			if (_TextDecoration == null)
		...
		public TextAlignEnum EvalTextAlign(Report rpt, Row row)
		{
			if (_TextAlign == null)
		...
		public VerticalAlignEnum EvalVerticalAlign(Report rpt, Row row)
		{
			if (_VerticalAlign == null)
		...
		public Color EvalColor(Report rpt, Row row)
		{
			if (_Color == null)
		...
		public float EvalPaddingLeft(Report rpt, Row row)
		{
			if (_PaddingLeft == null)
				return 0;
		...
		public int EvalPaddingLeftPx(Report rpt, Row row)
		{
			if (_PaddingLeft == null)
				return 0;
		...
		public float EvalPaddingRight(Report rpt, Row row)
		{
			if (_PaddingRight == null)
				return 0;
		...
		public int EvalPaddingRightPx(Report rpt, Row row)
		{
			if (_PaddingRight == null)
				return 0;
		...
		public float EvalPaddingTop(Report rpt, Row row)
		{
			if (_PaddingTop == null)
				return 0;
		...
		public int EvalPaddingTopPx(Report rpt, Row row)
		{
			if (_PaddingTop == null)
				return 0;
		...
		public float EvalPaddingBottom(Report rpt, Row row)
		{
			if (_PaddingBottom == null)
				return 0;
		...
		public int EvalPaddingBottomPx(Report rpt, Row row)
		{
			if (_PaddingBottom == null)
				return 0;
		...
		public float EvalLineHeight(Report rpt, Row r)
		{
			if (_LineHeight == null)
				return float.NaN;
		...
		public DirectionEnum EvalDirection(Report rpt, Row r)
		{
			if (_Direction == null)
		...
		public WritingModeEnum EvalWritingMode(Report rpt, Row r)
		{
			if (_WritingMode == null)
		...
		public Expression UnicodeBiDirectional
		{
			get { return  _UnicodeBiDirectional; }
			set {  _UnicodeBiDirectional = value; }
		}

		public UnicodeBiDirectionalEnum EvalUnicodeBiDirectional(Report rpt, Row r)
		{
			if (_UnicodeBiDirectional == null)
		...
		public CalendarEnum EvalCalendar(Report rpt, Row r)
		{
			if (_Calendar == null)
		...
		public string EvalNumeralLanguage(Report rpt, Row r)
		{
			if (_NumeralLanguage == null)
		...
		public int EvalNumeralVariant(Report rpt, Row r)
		{
			if (_NumeralVariant == null)
				return 1;
		...
		class WorkClass
		{
			public string CssStyle;		// When ConstantStyle is true; this will hold cache of css
