...
namespace Oranikle.Report.Engine
{
	...
	public class Table : DataRegion
	{
        ...
        public bool IsGrid { get { return _IsGrid; } }

		public void RunPageHeader(Pages pgs, Row frow, bool bFirst, TableGroup stoptg)
		{
        ...
        public void RunGroupsSetGroups(Report rpt, TableWorkClass wc, List<GroupEntry> groupEntries)
		{
			// set the group entry value
		...
		public DataElementOutputEnum DetailDataElementOutput
		{
			get { return  _DetailDataElementOutput; }
			set {  _DetailDataElementOutput = value; }
		}

		public int GetGroupNestCount(Report rpt)
		{
			TableWorkClass wc = GetValue(rpt);
			return wc.GroupNestCount;
		}

		public int WidthInPixels(Report rpt, Row row)
		{
	...
	{
		public Rows Data;	// Runtime data; either original query if no groups
		// or sorting or a copied version that is grouped/sorted
		public List<GroupEntry> Groups;		// Runtime groups; array of GroupEntry
		public int GroupNestCount;	// Runtime: calculated on fly for # of table rows that are part of a group
		//    used to handle toggling of a group 
		public Grouping RecursiveGroup;	// Runtime: set with a recursive; currently on support a single recursive group
		public TableWorkClass()
		{
			Data = null;
			Groups = null;
			GroupNestCount = 0;
	...
	class RecursiveCompare: IComparer<Row>
	{
        ...
        public RecursiveCompare(Report r, IExpr pExpr, TypeCode tc, IExpr gExpr)
		{
            rpt = r;
			_Type = tc;
			parentExpr = pExpr;
	...
	class GroupEntryCompare: IComparer<GroupEntry>
	{
		...
		public GroupEntryCompare(Report r, TableWorkClass w )
		{
			rpt = r;
			wc = w;
		}
