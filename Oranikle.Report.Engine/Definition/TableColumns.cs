...
namespace Oranikle.Report.Engine
{
	...
	///</summary>
	[Serializable]
	public class TableColumns : ReportLink, IEnumerable<TableColumn>
	{
        List<TableColumn> _Items;			// list of TableColumn

		public TableColumns(ReportDefn r, ReportLink p, XmlNode xNode) : base(r, p)
		{
			TableColumn tc;
		...
		public TableColumn this[int ci]
		{
			get
			{
		...
		public void CalculateXPositions(Report rpt, float startpos, Row row)
		{
			float x = startpos;
