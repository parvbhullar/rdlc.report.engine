...
namespace Oranikle.Report.Engine
{
	...
	public class Textbox : ReportItem
	{
		...
		public void AddExpressionReference(string name)
		{
		...
		public void ResetPrevious(Report rpt)
		{
		...
		public string RunText(Report rpt, Row row)
		{
		...
		public float RunTextCalcHeight(Report rpt, Graphics g, Row row)
		{
		...
		public object Evaluate(Report rpt, Row r)
		{
		...
		public bool IsHtml(Report rpt, Row row)
		{
		...
		public int RunCount(Report rpt)
		{
			TextboxRuntime tbr = TextboxRuntime.GetTextboxRuntime(rpt, this);
	...
	{
		public int RunCount=0;			// number of times TextBox is rendered at runtime;
											//    used to generate unique names for toggling visibility
		public float RunHeight=0;			// the runtime height (in points)
		public string PreviousText=null;	// previous text displayed
		public Page PreviousPage=null;	//  page previous text was shown on
