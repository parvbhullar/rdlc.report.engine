...
namespace Oranikle.Report.Engine
{
	...
	public class Parser
	{
		static public long Counter;			// counter used for unique expression count
		...
		/// Parse an expression.
		/// </summary>
        public Parser(List<ICacheData> c) 
		{
			_DataCache = c;
		}
		...
		public IExpr Parse(NameLookup lu, string expr)
		{
			_InAggregate = false;
		...
		public bool NoAggregateFunctions
			...
			{	// ok try for some of the system functions
				...
				switch(cls)
				{
					...
					case "Convert":
						...
						break;
					case "Financial":
						syscls = "Oranikle.Report.Engine.Financial";
						break;
					default:
						syscls = "Oranikle.Report.Engine.VBFunctions";
						break;
				}
				if (syscls != null)
				{
