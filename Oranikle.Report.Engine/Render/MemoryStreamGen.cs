...
namespace Oranikle.Report.Engine
{
	...
	public class MemoryStreamGen : IStreamGen, IDisposable
	{
		...
		public string Prefix;			// used as prefix to names generated
		public string Suffix;			// used as a suffix to names generated
		public string Extension="";		// extension name for first file
