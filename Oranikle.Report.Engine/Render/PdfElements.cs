...
namespace Oranikle.Report.Engine
{
	...
	public class PdfElements
	{
		...
		/// </summary>
		/// <returns></returns>
		public void AddLine(float x,float y, float x2, float y2, float width, System.Drawing.Color c, BorderStyleEnum ls)
		{
			// Get the line color
			double red=c.R; 
			double green=c.G; 
		...
		/// </summary>
		/// <returns></returns>
		public void AddFillRect(float x,float y, float width, float height, Color c)
		{
			// Get the fill color
			double red=c.R; 
			double green=c.G; 
		...
		public void AddFillRect(float x,float y, float width, float height,StyleInfo si,PdfPattern patterns)
		{
...
/// <param name="patterns"></param>
        public void AddPolygon(PointF[] pts, StyleInfo si, string url, PdfPattern patterns)
        {
		...
		/// </summary>
		/// <returns></returns>
		public void AddRectangle(float x, float y, float height, float width, StyleInfo si, string url, PdfPattern patterns, string tooltip)
		{
        ...
        public void AddPie(float x, float y, float height, float width, StyleInfo si, string url, PdfPattern patterns, string tooltip)
        {
            // Draw background rectangle if needed
            if (!si.BackgroundColor.IsEmpty && height > 0 && width > 0)
            {	// background color, height and width are specified
        ...
        //
        public void AddCurve(PointF[] pts, StyleInfo si)
        {
            if (pts.Length > 2)
            {   // do a spline curve
