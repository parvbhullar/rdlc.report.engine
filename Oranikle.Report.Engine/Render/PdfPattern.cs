...
namespace Oranikle.Report.Engine
{
	...
	public class PdfPattern
	{
		...
		public string GetPdfPattern(string patternname)
		{
		...
		/// </summary>
		/// <returns></returns>
		public byte[] GetPatternDict(long filePos,out int size)
		{
	...
	public class PatternObj:PdfBase
	{
		public string Patternobj;
		
		
		public PatternObj(PdfAnchor pa):base(pa)
		{
			Patternobj = string.Format("\r\n{0} 0 obj\r\n [ /Pattern /DeviceRGB ]\r\n endobj",this.objectNum);
		}
		
		public byte[] GetPatternObj(long filePos,out int size)
		{
	...
	/// </summary>
	public class PdfPatternEntry:PdfBase
	{
		public string patternDict;
		public string pattern;

		/// <summary>
		/// Create the font Dictionary
		/// </summary>
		public PdfPatternEntry(PdfAnchor pa,String patternName,String patternType):base(pa)
		{
            pattern = patternName;    
            switch (patternType)
            {
		...
		public string BackwardDiagonal()
		{
		...
		public string DarkDownwardDiagonal()
		{
			System.Text.StringBuilder sb = new System.Text.StringBuilder();  
            System.Text.StringBuilder stream = new System.Text.StringBuilder();
            stream.Append("\r\n\t 0.4 w\t[] 0 d\t 0 7 m\t7 0 l\tS\t\t");
