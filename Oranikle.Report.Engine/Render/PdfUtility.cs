...
namespace Oranikle.Report.Engine
{
    ...
    public class PdfUtility
    {
        ...
        /// </summary>
        /// <returns></returns>
        public byte[] GetTrailer(int refRoot, int refInfo, out int size)
        {
            string trailer = null;
            string infoDict;
            try
        ...
        /// <param name="size"></param>
        /// <returns></returns>
        static public byte[] GetUTF8Bytes(string str, out int size)
        {
            try
            {
