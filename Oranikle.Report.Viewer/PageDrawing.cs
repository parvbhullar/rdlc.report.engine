...
namespace Oranikle.Report.Viewer
{
    ...
    public class PageDrawing : UserControl
    {
        ...
        /// </summary>
        internal System.Drawing.Image SelectImage
        {
            get
            {
        ...
        protected override void OnMouseUp(MouseEventArgs e)
        {
            ...
            if (this._ptRBLast.X != -1)
            {
                ...
                System.Drawing.Rectangle r = RectFromPoints(this._ptRBOriginal, this._ptRBLast);
            ...
            {   // no last rectangle but use still might have clicked on a pageItem
                ...
                System.Drawing.Rectangle r = RectFromPoints(this._ptRBOriginal, this._ptRBOriginal);
                CreateSelectionList(r, bCtrlOn);         // create the selection list
            }
        ...
        private void RubberBand(Point p1, Point p2)
        {
            ...
            System.Drawing.Rectangle rc = RectFromPoints(p1, p2);
        ...
        private void CreateSelectionList(System.Drawing.Rectangle rc, bool bCtrlOn)
        {
            if (_HitList.Count <= 0)
                return;
        ...
        private System.Drawing.Rectangle RectFromPoints(Point p1, Point p2)
        {
