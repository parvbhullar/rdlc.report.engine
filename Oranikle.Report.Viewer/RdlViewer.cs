...
namespace Oranikle.Report.Viewer
{
	...
	public class RdlViewer : System.Windows.Forms.Control
	{
		...
		private Oranikle.Report.Engine.Report _Report;				// the report
...
//					_vScroll.Value = (int)((double)_vScroll.Maximum / _pgs.PageCount * (value -1)); 
		...
		/// </summary>
		public Oranikle.Report.Engine.Report Report
		{
			get 
			{
				LoadPageIfNeeded();
        ...
        public void Copy()
        {
            ...
            System.Drawing.Image im = _DrawPanel.SelectImage;
            if (im == null)
...
<Report> 
	...
	<PageHeader>
		<Height>1 in</Height>
		<ReportItems>
			<Textbox><Top>.1in</Top><Value>Oranikle Venture Inc.</Value><Style><FontSize>18pt</FontSize><FontWeight>Bold</FontWeight></Style></Textbox>
