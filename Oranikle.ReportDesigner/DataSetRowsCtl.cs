...
namespace Oranikle.ReportDesigner
{
	...
	/// </summary>
	internal class DataSetRowsCtl : Oranikle.ReportDesigner.Base.BaseControl, IProperty
	{
		...
		private Oranikle.Studio.Controls.StyledCheckBox chkRowsFile;
		private Oranikle.Studio.Controls.StyledButton bRowsFile;
		private System.Windows.Forms.DataGrid dgRows;
		private Oranikle.Studio.Controls.CustomTextControl tbRowsFile;
		private System.Windows.Forms.Label label1;
		private Oranikle.Studio.Controls.StyledButton bLoad;
		private Oranikle.Studio.Controls.StyledButton bClear;
		/// <summary> 
		...
		private void CreateDataTable()
		{
			...
			foreach (DataRow dr in _dsv.Fields.Rows)
			{
                ...
                Type t = type == null || type.Length == 0? typeof(string): 
                    Oranikle.Report.Engine.DataType.GetStyleType(type);
