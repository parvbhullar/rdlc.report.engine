	...
	{ 
		...
		private void DrawPanelPaint(object sender, System.Windows.Forms.PaintEventArgs e)
		{
			...
			{	// don't want to kill process if we die -- put up some kind of error message
				...
				g.DrawString(msg, this.Font, Brushes.Black, new System.Drawing.Rectangle(2, 2, this.Width, this.Height), format);
		...
		private void DrawPanelMouseUp(object sender, MouseEventArgs e)
		{
			...
			{	// Handle the end of the rubber banding
				...
				if (this._ptRBLast.X != -1)
				{
					...
					System.Drawing.Rectangle r = DrawPanelRectFromPoints(this._ptRBOriginal, this._ptRBLast);
		...
		private void DrawPanelContextMenuTable(Point p, XmlNode riNode)
		{
			...
			MenuItem menuReplRectangle = new MenuItem("&System.Drawing.Rectangle", new EventHandler(this.menuInsertRectangle_Click));
			MenuItem menuReplImage = new MenuItem("&System.Drawing.Image", new EventHandler(this.menuInsertImage_Click));
		...
		private bool DrawPanelMouseDownRubberBand(object sender, MouseEventArgs e)
		{
			...
			if (_MouseDownNode == null)
				bRubber = true;
			else if (_MouseDownNode.Name == "List" || _MouseDownNode.Name == "System.Drawing.Rectangle")
			{
		...
		private void DrawPanelRubberBand(Point p1, Point p2)
		{
			...
			System.Drawing.Rectangle rc = DrawPanelRectFromPoints(p1, p2);
		...
		private System.Drawing.Rectangle DrawPanelRectFromPoints(Point p1, Point p2)
		{
		...
		private void DrawPanelKeyDown(object sender, KeyEventArgs e)
		{
			...
			else if (e.KeyCode == Keys.Tab)
			{
				if (_DrawPanel.SelectNext((Control.ModifierKeys & Keys.Shift) == Keys.Shift))
				{
					...
					System.Drawing.Rectangle nr = new System.Drawing.Rectangle(PixelsX(r.X), PixelsY(r.Y), PixelsX(r.Width), PixelsY(r.Height));
		...
		private void menuPaste_Click(object sender, EventArgs e)
		{
			...
			if (!(lNode.Name == "List" ||
				lNode.Name == "Body" ||
				lNode.Name == "System.Drawing.Rectangle" ||
...
"<fyi:Grid xmlns:fyi=\"http://www.oranikle.in/schemas\" Name=\"Grid1\">" +
        @"<Style>
          <BorderStyle>
		...
		{
			string ri = "<ReportItems><System.Drawing.Image><Height>1.5in</Height><Width>1.5in</Width></System.Drawing.Image></ReportItems>";
			menuInsertReportItem(sender, e, ri);
		}
		...
		{
			string ri = "<ReportItems><System.Drawing.Rectangle><Height>1.5in</Height><Width>1.5in</Width></System.Drawing.Rectangle></ReportItems>";
			menuInsertReportItem(sender, e, ri);
		}
		...
		private void doSelectAll()
		{
			...
			{
				if (riNode.Name == "Table" || riNode.Name == "fyi:Grid" || riNode.Name == "List" || riNode.Name == "System.Drawing.Rectangle")
