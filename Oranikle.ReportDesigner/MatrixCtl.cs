...
namespace Oranikle.ReportDesigner
{
	...
	/// </summary>
	internal class MatrixCtl : Oranikle.ReportDesigner.Base.BaseControl, IProperty
	{
		...
		private Oranikle.Studio.Controls.StyledCheckBox chkCellContents;
		private Oranikle.Studio.Controls.CustomTextControl tbCellDataElementName;
		/// <summary> 
