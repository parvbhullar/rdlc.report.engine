...
namespace Oranikle.ReportDesigner
{
	...
	/// </summary>
	public class RdlEditPreview : Oranikle.ReportDesigner.Base.BaseControl
	{
        
		private Oranikle.Studio.Controls.CtrlStyledTab tcEHP;
		...
		private Oranikle.Report.Viewer.RdlViewer rdlPreview;
        ...
        private DesignEditLines pbLines = new DesignEditLines();
...
//				offset += this.tbEditor.Lines[i].Length + 1; 
        ...
        private void rdlPreview_Click(object sender, EventArgs e)
        {
