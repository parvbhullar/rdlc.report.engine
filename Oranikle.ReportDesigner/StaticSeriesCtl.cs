    ...
    public partial class StaticSeriesCtl : UserControl, IProperty
     {
        ...
        public void Apply()
        {
            ...
            {              
                ...
                {
                    ncdc.InnerXml += "<ChartSeries><fyi:Color xmlns:fyi=\"http://www.oranikle.in/schemas\">" + si.Colour + "</fyi:Color><PlotType>" + si.PlotType + "</PlotType><fyi:NoMarker xmlns:fyi=\"http://www.oranikle.in/schemas\">" + si.NoMarker + "</fyi:NoMarker><fyi:LineSize xmlns:fyi=\"http://www.oranikle.in/schemas\">" + si.LineSize + "</fyi:LineSize><YAxis>" + si.YAxis +
                ...
                {
                    ncdc.InnerXml += "<ChartSeries><fyi:Color xmlns:fyi=\"http://www.oranikle.in/schemas\">" + si.Colour + "</fyi:Color><PlotType>" + si.PlotType + "</PlotType><fyi:NoMarker xmlns:fyi=\"http://www.oranikle.in/schemas\">" + si.NoMarker + "</fyi:NoMarker><fyi:LineSize xmlns:fyi=\"http://www.oranikle.in/schemas\">" + si.LineSize + "</fyi:LineSize><YAxis>" + si.YAxis + "</YAxis><DataPoints><DataPoint><DataValues><DataValue><Value>" // 20022008 AJM GJL
                        + si.Data.Replace("<", "&lt;").Replace(">", "&gt;") + "</Value></DataValue></DataValues><DataLabel><Value>" + si.Label.Replace("<", "&lt;").Replace(">", "&gt;") + "</Value><Visible>" + si.ShowLabel.ToString()
                        + "</Visible></DataLabel></DataPoint></DataPoints></ChartSeries>";
                }
            }
